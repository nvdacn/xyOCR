...
addon_info = AddonInfo(
	...
	addon_url="https://github.com/huaiyinfeilong/xyOCR",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/huaiyinfeilong/xyOCR",
	...
	addon_license="Apache License 2.0",
...
pythonSources: list[str] = ["addon/globalPlugins/xyOCR/*.py", "addon/installTasks.py"]
